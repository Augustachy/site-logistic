 ...
 function Home() {
  ...
  return (
    ...
    <div className='hero'>
       ...
       <h1 className='mt-5'>Easy & Quick Cargo Shipping Services</h1>
        <p style={{fontSize:'24px'}}>Book low cost sea freight shipping services. <br /> Get an instant quote.</p>
...
<div className="container">
   ...
   <p className='pt-3'>Crystal Shipments is more than logistics. We can also optimize your packaging, manage your materials sourcing, and much more. </p>
    </div>
